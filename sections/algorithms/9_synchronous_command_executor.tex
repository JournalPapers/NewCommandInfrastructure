...
Alternative implementations (e.g., \texttt{AsyncCommandExecutor}, \texttt{DisruptorCommandExecutor}) can extend this pattern to achieve non-blocking or event-driven semantics. \shortcite{lopez2020triggerflow}